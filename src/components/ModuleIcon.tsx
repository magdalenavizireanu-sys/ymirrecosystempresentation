 ...
 * or — for Niu/Jarn — the official mark supplied directly) when one exists.
 * When it doesn't — ysdr, claude-engine, brainstormer-aggregator — we
 * deliberately do NOT invent a matching 3D icon. Instead we reuse the
 * brand's own "module input marker" vocabulary (square / circle / triangle /
 * diamond, from the Symbol Anatomy page) as a neutral placeholder, and rely
 * on the "no official icon yet" note in the UI.
 */
